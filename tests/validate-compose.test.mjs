...
test('accepts valid Compose with different space indentation widths', () => {
...
test('supports anchors and literal scripts and does not expand Compose variables', () => {
