...
export default function Home() {
  ...
  const checkUpdates = useCallback(async (force = false) => {
    setChecking(true);
    try { await post('/api/updates/check', { force }); await refresh(); if (force) setNotice({ type: 'ok', text: 'latest 镜像检查完成' }); }
