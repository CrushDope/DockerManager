...
type Page = '容器管理' | '镜像管理' | 'Compose 项目' | '启动顺序' | '加速源配置';
...
const navigation: Array<{ label: Page; icon: typeof Box }> = [
  ...
  { label: 'Compose 项目', icon: Layers }, { label: '启动顺序', icon: ListOrdered },
  { label: '加速源配置', icon: Zap },
];
...
export default function Home() {
  ...
  useEffect(() => {
    if (page !== '启动顺序' && page !== '加速源配置') return;
